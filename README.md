...
* [TelloPy](https://github.com/hanyazou/TelloPy) ⭐ 719 | 🐛 43 | 🌐 Python | 📅 2024-07-23 - `#Python`, unmaintained, SDK 1.3 and lowlevel, pretty pythonic with examples, only inline docs
...
* [Drone hacking tool analysis - dronesploit](https://dronesec.com/blogs/articles/drone-hacking-tool-analysis-dronesploit) - Hijacking using [dronesploit-framework](https://github.com/dhondta/dronesploit) ⭐ 2,173 | 🐛 2 | 🌐 Python | 📅 2024-11-23
